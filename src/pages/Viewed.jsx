...
//         {/* Sidebar */}
//         <aside className="w-64 bg-gray-200 text-black h-screen p-4  ">
...
//         <div className=" bg-white rounded-t-2xl-custom w-full -my-6">

//           <div className=" rounded-3xl w-full -my-2">
//             {gridData.map((item) => (
...
//       {/* Footer */}
//       <footer className="container text-white  fixed bottom-0 left-0 mx-auto mb-5">
//         <Footer />
//       </footer>
//     </div>
//   );
